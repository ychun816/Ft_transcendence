...
const getDockerHostIP = () => {
    ...
    try {
        ...
        console.log("⚠️ Impossible d'exécuter les commandes de détection réseau:", error.message);
    }
...
const PUBLIC_IP = determinePublicIP();
