                    ...
                    <div class="retro-panel rounded-lg p-6 shadow-2xl w-full max-w-4xl">
                        ...
                        <div class="mt-6 text-center">
                            <div class="retro-panel rounded-lg p-4 inline-block">
                                <h4 class="text-lg font-semibold neon-text mb-2">🎮 Contrôles (2 joueurs)</h4>
                                <div class="grid grid-cols-2 gap-4 text-sm text-purple-300">
                                    <div>
                                    ...
                                    <div>
                                        <strong class="text-pink-400">Joueur 2:</strong><br>
                                        ↑ = Haut<br>
                                        ↓ = Bas
                                    </div>
                                </div>
