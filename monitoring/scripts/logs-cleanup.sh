...
# Script de nettoyage Elasticsearch avec protection contre les doubles exécutions
...
echo "[DEBUG] $(date) - Variables d'environnement:" >> /tmp/cleanup-debug.log
echo "ELASTIC_URL: $ELASTIC_URL" >> /tmp/cleanup-debug.log
echo "ELASTIC_USER: $ELASTIC_USER" >> /tmp/cleanup-debug.log
echo "ELASTIC_PASSWORD: [${#ELASTIC_PASSWORD} caractères]" >> /tmp/cleanup-debug.log
echo "SCRIPT_PID: $SCRIPT_PID" >> /tmp/cleanup-debug.log
